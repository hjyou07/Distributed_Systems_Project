...
public class StoreInfo {
  Integer[][] itemByStore;
  private final int NUM_ITEMS = 100000;
  private final int NUM_STORES = 512;
  private static StoreInfo instance = null;

  protected StoreInfo() { itemByStore = new Integer[NUM_ITEMS][NUM_STORES];}

  public static StoreInfo getInstance() {
    if (instance == null) instance = new StoreInfo();
    return instance;
  }
  ...
  public void putSalesInfo(int storeID, int itemID, int quantity) {
    int row = itemID - 1;
    int col = storeID - 1;
